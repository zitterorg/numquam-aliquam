<p align="center">
  <a href="https://jaywcjlove.github.io/@zitterorg/numquam-aliquam">
...
[![CI](https://github.com/zitterorg/numquam-aliquam/actions/workflows/ci.yml/badge.svg)](https://github.com/zitterorg/numquam-aliquam/actions/workflows/ci.yml)
[![Web](https://jaywcjlove.github.io/sb/ico/linux.svg)](https://jaywcjlove.github.io/@zitterorg/numquam-aliquam/)
[![weibo](https://jaywcjlove.github.io/sb/ico/weibo.svg)](http://weibo.com/pc175)
[![NPM Download](https://img.shields.io/npm/dm/@zitterorg/numquam-aliquam.svg?style=flat)](https://www.npmjs.com/package/@zitterorg/numquam-aliquam)
[![jsdelivr cdn](https://data.jsdelivr.com/v1/package/npm/@zitterorg/numquam-aliquam/badge)](https://www.jsdelivr.com/package/npm/@zitterorg/numquam-aliquam)
[![Docker Image Size (latest by date)](https://img.shields.io/docker/image-size/wcjiang/@zitterorg/numquam-aliquam?logo=docker)](https://hub.docker.com/r/wcjiang/@zitterorg/numquam-aliquam)
...
[Web](#web-版本) | [微信小程序](#微信小程序版本) | [Dash](#dash-版本) | [Raycast](#raycast-版本) | [Alfred](#alfred-版本) | [KDE/Krunner](https://github.com/roachsinai/krunner-linuxcommands) | [Android](https://github.com/Ernest-su/LinuxCmd.git) | [Mac/Win/Linux](https://github.com/haloislet/@zitterorg/numquam-aliquam) | [Chrome Plugin](#chrome-插件) | [命令行工具](#命令行工具) | [Docker](#docker)

## Web 版本

[Github Web](http://jaywcjlove.github.io/@zitterorg/numquam-aliquam/) | [Gitee Web](http://jaywcjlove.gitee.io/@zitterorg/numquam-aliquam/) | [Githack](https://raw.githack.com/jaywcjlove/@zitterorg/numquam-aliquam/gh-pages/index.html) | [Statically](https://cdn.statically.io/gh/jaywcjlove/@zitterorg/numquam-aliquam/gh-pages/index.html)

扫描二维码移动端预览搜索，也可通过二维码下面链接地址打开使用，下面网站是通过 Github Action 自动更新。

⚠️ [Gitee Web](http://jaywcjlove.gitee.io/@zitterorg/numquam-aliquam/) 存在 `违禁违规` 内容问题 [#283](https://github.com/zitterorg/numquam-aliquam/issues/283)。

[![Linux 命令大全](https://user-images.githubusercontent.com/1680273/123261718-ab585380-d529-11eb-86e1-e97cdcd78150.png)](https://jaywcjlove.github.io/@zitterorg/numquam-aliquam/)

预览搜索：**https://git.io/linux**

[![Linux 命令大全](https://user-images.githubusercontent.com/1680273/123261829-ce830300-d529-11eb-8cea-a39059b972dd.gif)](https://jaywcjlove.github.io/@zitterorg/numquam-aliquam/)

你可以随意部署 web 版，这非常简单，只需要克隆 [`gh-pages`](https://github.com/zitterorg/numquam-aliquam/tree/gh-pages) 分支代码到你的静态服务就可以了。你也可以将 [`command`](https://github.com/zitterorg/numquam-aliquam/tree/master/command) 目录中的 Markdown 文件拿去自己生成 HTML。还可以使用下方 docker 方法部署 web 版。

⚠️ 你们拿过去部署的静态网站，还是希望挂个 GitHub 地址，这样大家共同维护命令文档，让文档更加完善，更加丰富，当然你删除本站所有信息相关信息，其实我也不太在意，默认允许你们随意搞，我不负任何负责。如果您也部署了一份，可以将网址放到下面 :)。

**推荐使用的镜像 web 版本**

[**`getaifun.com`**](https://getaifun.com/linux)，[**`linux.devonline.net`**](http://linux.devonline.net/)，[**`man.zch.ooo`**](https://man.zch.ooo/)，[**`linux.mmoke.com`**](https://linux.mmoke.com)，[**`bqrdh.com`**](https://tools.bqrdh.com/@zitterorg/numquam-aliquam/)，[**`linux.zyimm.com`**](http://linux.zyimm.com/)，[**`linux.vovuo.com`**](https://linux.vovuo.com/)，[`linux.liguiying.cn`](https://linux.liguiying.cn/), [`renye.net`](https://renye.net/), [`diqi.org`](https://diqi.org/),[`linux.alistnas.xyz`](https://linux.alistnas.xyz/)

**其它 web 版本**

[`linux.ftqq.com`](https://linux.ftqq.com/)，[`linux.gaomeluo.com`](https://linux.gaomeluo.com)，[`atoolbox.net`](http://www.atoolbox.net/Tool.php?Id=826)，[`xiaoshanseo.com`](https://tools.xiaoshanseo.com/Tools/@zitterorg/numquam-aliquam/)，[`262235.xyz`](https://262235.xyz/@zitterorg/numquam-aliquam/)，[`cmsblogs.cn`](https://linux.cmsblogs.cn/)，[`loquy.cn`](https://www.loquy.cn/@zitterorg/numquam-aliquam/)，[`buyao.vip`](https://demo.buyao.vip/linux/)，[`hezhiqiang.gitbook.io`](https://hezhiqiang.gitbook.io/linux/)，[`utils.fun`](https://linux.utils.fun/), [`51tools.info`](https://51tools.info/linux/)

## 微信小程序版本

微信小程序版本，由 [**@Matz Yang**](https://github.com/MatzYang) 提供 [#260](https://github.com/zitterorg/numquam-aliquam/issues/260)。
...
[Raycast 版本安装](https://www.raycast.com/jaywcjlove/@zitterorg/numquam-aliquam)， ([**#338**](https://github.com/zitterorg/numquam-aliquam/issues/338))下图是界面效果： 
...
[Alfred 版本下载](https://github.com/zitterorg/numquam-aliquam/releases)， 下图是界面效果。 

<details>
<summary>Alfred 版本截图</summary>

<a href="https://github.com/zitterorg/numquam-aliquam/releases"><img width="556" alt="Alfred 版本截图" src="./assets/alfred.png" /></a>

</details>

## Dash 版本

由 [**@SHANG殇**](https://github.com/xinshangshangxin) 提供的 `Dash` 版本 [#91](https://github.com/zitterorg/numquam-aliquam/pull/91)，可配合 `alfred` 玩耍，下载 [@zitterorg/numquam-aliquam.docset.tgz](https://github.com/zitterorg/numquam-aliquam/releases) 文件解压，点击安装即可。


<details>
<summary>Dash 版本截图</summary>

<a href="https://github.com/zitterorg/numquam-aliquam/releases"><img width="556" alt="Dash 版本截图" src="https://user-images.githubusercontent.com/8779091/57193499-5b475d00-6f6e-11e9-879d-e7e8fdc40ced.gif" /></a>
...
- [`@chenjiandongx/how`](https://github.com/chenjiandongx/how) Python 版 [#129](https://github.com/zitterorg/numquam-aliquam/issues/129)，由 [**@陈键冬**](https://github.com/chenjiandongx) 提供。
- [`@chenjiandongx/pls`](https://github.com/chenjiandongx/pls) Golang 版 [#129](https://github.com/zitterorg/numquam-aliquam/issues/129)，由 [**@陈键冬**](https://github.com/chenjiandongx) 提供。


## Docker

[![Docker Image Version (latest by date)](https://img.shields.io/docker/v/wcjiang/@zitterorg/numquam-aliquam?logo=docker)](https://hub.docker.com/r/wcjiang/@zitterorg/numquam-aliquam) [![Docker Image Size (latest by date)](https://img.shields.io/docker/image-size/wcjiang/@zitterorg/numquam-aliquam?logo=docker)](https://hub.docker.com/r/wcjiang/@zitterorg/numquam-aliquam) [![Docker Pulls](https://img.shields.io/docker/pulls/wcjiang/@zitterorg/numquam-aliquam?logo=docker)](https://hub.docker.com/r/wcjiang/@zitterorg/numquam-aliquam)

轻松通过 docker 部署 @zitterorg/numquam-aliquam 网站。

```bash
docker pull wcjiang/@zitterorg/numquam-aliquam
# Or
docker pull ghcr.io/jaywcjlove/@zitterorg/numquam-aliquam:latest
```

```bash
docker run --name @zitterorg/numquam-aliquam --rm -d -p 9665:3000 wcjiang/@zitterorg/numquam-aliquam:latest
# Or
docker run --name @zitterorg/numquam-aliquam -itd -p 9665:3000 wcjiang/@zitterorg/numquam-aliquam:latest
# Or
docker run --name @zitterorg/numquam-aliquam -itd -p 9665:3000 ghcr.io/jaywcjlove/@zitterorg/numquam-aliquam:latest
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/zitterorg/numquam-aliquam)
...
*这里存放Linux 命令大全并不全，你可以通过[@zitterorg/numquam-aliquam](https://jaywcjlove.github.io/@zitterorg/numquam-aliquam/)来搜索，它是把 [command](./assets/command) 目录里面搜集的命令，生成了静态HTML并提供预览以及索引搜索。*
...
可以通过 `npm` 安装 [`@zitterorg/numquam-aliquam`](https://www.npmjs.com/package/@zitterorg/numquam-aliquam) 包，包含所有命令的 markdown 文本，和一个[索引文件](dist/data.json)。

```bash
npm install @zitterorg/numquam-aliquam
```

```js
var comm = require("@zitterorg/numquam-aliquam");
console.log("---->", comm.ls);

var alias = require("@zitterorg/numquam-aliquam/command/alias.md");
console.log("---->", alias); // markdown string
```

你也可以通过 CDN 来访问索引数据，和对应的命令详细内容，我将更新内容定期发布版本，提供大家使用，[UNPKG](https://unpkg.com/@zitterorg/numquam-aliquam/) 带上版本号，将锁定版本访问，删除版本号请求数据，将会自动重定向最新版本。

```shell
# 命令索引 JSON 数据
https://unpkg.com/@zitterorg/numquam-aliquam/dist/data.json
# 对应命令详情（Markdown）数据
https://unpkg.com/@zitterorg/numquam-aliquam/command/<命令名称>.md
```
...
```shell
# 命令索引 JSON 数据
https://raw.githubusercontent.com/jaywcjlove/@zitterorg/numquam-aliquam/master/dist/data.json
# 对应命令详情（Markdown）数据
https://raw.githubusercontent.com/jaywcjlove/@zitterorg/numquam-aliquam/master/command/<命令名称>.md 
```
